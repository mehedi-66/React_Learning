...
// ******************** useMemo Hooks ***********************
/*
    To fix this performance issue, we can use the useMemo Hook to memoize the
    expensiveCalculation function. This will cause the function to only run when needed.
